...
const AnalysisHistory = dynamic(() => import('@/components/profile/AnalysisHistory'), {
  ssr: false,
  loading: () => (
    <div className="frosted-glass rounded-2xl p-8 shadow-xl mb-8">
  ...
  return (
    <div className="min-h-screen bg-background py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        {user && <AnalysisHistory userId={user.uid} />}
